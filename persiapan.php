...
<div class="jumbotron jumbotron-fluid">
    <div class="container text-justify">
        ...
        <p class="lead">Sebelum memulai membuat login kita harus mempersiapkan beberapa hal terlebih dahulu.<br>Yang harus di siapkan adalah sebagai berikut</p>
        ...
        <section id="php">
            ...
            <p>Disini anda mungkin ingin merubah direktori tempat XAMPP nya, misal ke <code>E:/</code>. Dan jangan lupa untuk menambahkan versi XAMPP di belakang direktori agar tidak bertabrakan dengan XAMPP sebelumnya yang sudah anda install.<br>Berikut contohnya</p>
